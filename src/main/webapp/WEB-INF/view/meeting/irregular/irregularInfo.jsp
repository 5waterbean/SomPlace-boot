...
.irregular_delete_btn, .irregular_close_btn, .irregular_cancel_close_btn,
	.irregular_apply_btn, .irregular_cancel_apply_btn,
...
<body>
	...
	<div class="container" id="container">
		<form action="/meeting/irregular/update/form">
			<div>
				...
				<input type="hidden" name="checkedById"
					value="${irregular.meetingId}"> <input type="hidden"
					id="close" name="close" value="${irregular.close}">
				<!-- 모집 마감 -->
				<input type="hidden" id="cancel" name="cancel"
					value="${irregular.cancel}">
				<!-- 모임 삭제 -->
			...
			<div class="irregular_create_first">
				...
				<div class="creator">
					...
					<input type="text" id="creatorId"
						value=" ${creatorMember.major} / ${creatorMember.studentNumber} "
						disabled>
				</div>
			</div>
			...
			<table>
				...
				<tr>
					...
					<td colspan="3"><input type="text" id="maxPeople"
						name="maxPeople" required size="3"
						value="${irregular.numOfPeople} / ${irregular.maxPeople}" disabled>
						<strong>명</strong></td>
				</tr>
				<tr>
					<th>모임 장소</th>
					<td colspan="3"><input type="text" id="meetingPlace"
						name="meetingPlace" required size="30"
						value="${irregular.meetingPlace}" disabled></td>
				</tr>
				<tr>
					<th>모임 날짜/시간</th>
				...
				<tr>
					<th></th>
					<td colspan="3"><input type="hidden" name="detailValue"
						value="${detailValue}"> <c:set var="detailList"
								...
								<div class="member_list_td">
									<div>
										...
										<div class="member_good_btn"
											onClick="rateMember('${irregular.creatorId}','like')">
											<img src="../../../img/좋아요.png">
										</div>
										<div class="member_bad_btn"
											onClick="rateMember('${irregular.creatorId}','dislike')">
											<img src="../../../img/싫어요.png">
										</div>
									</div>
								</div>
					...
					<td style="width: 15%"><c:if
							...
							<c:if test="${irregular.creatorId ne memberSession.memberId}">
								<c:if
									...
									<div class="irregular_cancel_apply_btn"
		...
		<form name="memberOutForm" id="memberOutForm" action="/meeting/join">
			<input type="hidden" name="checkedById"
				value="${irregular.meetingId}"> <input type="hidden"
				name="applyMemberId" id="memberOut"> <input type="hidden"
				name="inOrOut" value="0"> <input type="hidden" name="count"
				value="${irregular.numOfPeople}">
		</form>
		<form name="memberInForm" id="memberInForm" action="/meeting/join">
			<input type="hidden" name="checkedById"
				value="${irregular.meetingId}"> <input type="hidden"
				name="applyMemberId" id="memberIn"> <input type="hidden"
				name="inOrOut" value="1"> <input type="hidden" name="count"
				value="${irregular.numOfPeople}">
		</form>
